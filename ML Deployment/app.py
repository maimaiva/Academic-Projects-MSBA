### Script for ML Deployment Project
import os
import json
import requests
import SessionState
...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "ids594mldeployment-634c5e3e0a2d.json"
PROJECT = "ids594mldeployment" # change for your GCP project
